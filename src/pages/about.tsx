    ...
    <Layout>
      ...
      <div className="bg-white dark:bg-gray-900 min-h-screen py-12 px-4 sm:px-6 lg:px-8">
        <div className="max-w-4xl mx-auto">
          ...
          >
            <h2 className="text-2xl font-semibold text-gray-800 dark:text-white mb-4">プロフェッショナルとしての旅</h2>
          ...
          >
            <h2 className="text-2xl font-semibold text-gray-800 dark:text-white mb-4">私の目標</h2>
