...
import { SunIcon, MoonIcon, MinusIcon, XMarkIcon } from '@heroicons/react/24/outline';
...
const Layout: React.FC<LayoutProps> = ({ children }) => {
  ...
  return (
    <div className={`min-h-screen flex flex-col ${theme === 'dark' ? 'dark' : ''} ${router.locale === 'ar' ? 'rtl' : ''}`}>
